...
// We need a wrapper component to use useSearchParams in Next.js safely
function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Hard Refresh to update Server Components with new Cookie
      router.refresh();
    ...
    <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-md">
      ...
      <div className="mt-4 text-center">
        ...
        <a
          ...
          className="flex w-full items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 shadow-sm"
        >
          {/* Google Icon SVG */}
